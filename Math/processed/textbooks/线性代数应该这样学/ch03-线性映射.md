...
$$
\dim \text {n u l l} S \leq \dim \text {n u l l} S + \dim \text {n u l l} T.
$$

23 设 $U$ 和 $V$ 都是有限维向量空间， $S \in { \mathcal { L } } ( V , W )$ 和 $T \in { \mathcal { L } } ( U , V )$ ，证明：

$$
\dim \operatorname {r a n g e} S \leq \min  \left\{\dim \operatorname {r a n g e} S, \dim \operatorname {r a n g e} T \right\}.
$$
